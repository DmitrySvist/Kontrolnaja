...
input_search_word_for_delete ='Введитк слово для поиска, котрые хотиет удалить: '
...
def find_contact_added_successful(name: str) -> str:
    return f'Контакты "{name}" успешно добавлен!'

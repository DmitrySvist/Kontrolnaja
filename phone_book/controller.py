...
def find_contact(message):
    ...
    view.snow_contacts(result, text.find_contact_no_resault(search_word))
    ...
    while True:
        ...
        match user_choice:
            case 1:
                ...
                view.snow_message(text.open_phone_book_opened_successful)
            case 2:    
                model.save_phone_book()
                view.snow_message(text.saved_phone_book_opened_successful)
            case 3:
            ...
            case 7:
                if find_contact(text.input_search_word_for_delete):
